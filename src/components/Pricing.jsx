...
export default function Pricing() {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      // Animate the button with a slight delay and pop
    ...
    <section id="pricing" ref={sectionRef} className="py-32 px-6 bg-background relative z-20 rounded-t-[3rem] -mt-10 border-t border-black/5">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="font-sans text-dark/70 mb-12 max-w-xl mx-auto text-lg">
          Únete a un grupo exclusivo de 8 profesionales. Eleva tu precisión diagnóstica con expertos de talla internacional.
        </p>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent/10 text-accent rounded-full text-xs font-bold uppercase tracking-wider mb-4">
                Próxima Edición: 1 de Agosto
              </div>
              <h3 className="font-sans font-bold text-3xl text-primary mb-2">Curso de Tomografía</h3>
              <div className="flex items-baseline gap-2 mb-6">
                <span className="font-sans font-bold text-4xl md:text-5xl text-dark">$450.000</span>
              ...
              <ul className="space-y-3 font-sans text-sm text-dark/80 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span>Teórico-Práctico (Traer laptop y archivo DICOM)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-accent shrink-0" />
