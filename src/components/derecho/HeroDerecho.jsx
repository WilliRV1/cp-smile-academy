...
export default function HeroDerecho() {
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="hero-el font-sans text-dark/70 mt-4 max-w-xl text-lg leading-relaxed mb-8">
            Blinda legal y éticamente tu consulta odontológica. Transforma la imagen diagnóstica de un simple paso clínico a una verdadera garantía legal frente a procesos jurídicos.
          </p>
