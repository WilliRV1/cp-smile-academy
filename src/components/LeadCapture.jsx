    ...
    <section className="py-20 px-6 bg-primary text-white relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <p className="font-sans text-white/80 mb-8 text-lg">
          Descarga el temario completo en PDF, conoce los detalles anatómicos que cubriremos y recibe una sorpresa especial.
        </p>
        <a 
          href="https://wa.me/19293430985?text=Hola,%20me%20gustar%C3%ADa%20recibir%20el%20temario%20en%20PDF%20del%20curso%20de%20Tomograf%C3%ADa." 
          target="_blank" 
